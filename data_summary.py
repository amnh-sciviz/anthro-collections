...
parser.add_argument('-counts', dest="FIELDS_COUNTS", default="Acquisition Year,Categories,Collection,Collector,Country,Culture,Date,Donor,Hall,Keywords,Locale,Material,Period,Subject,Technique,Dimensions", help="List of fields to show counts")
