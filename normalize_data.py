...
# python3 normalize_data.py -fields "Catalog No,Title,URL,Filename,Region,Acquisition Year,Acquisition Type,Acquisition Year Confidence,Acquisition Type Confidence,Country,Country Confidence,Hall,Donor,Donor Confidence,Latitude,Longitude"
...
parser.add_argument('-fields', dest="FIELD_LIST", default="", help="Comma-separated list of fields to output; leave blank for everything")
a = parser.parse_args()
...
cleanedItems = [{
    "Id": re.sub('[^0-9a-zA-Z\_]+', '_', item["Catalog No"]),
    "Title": item["Title"],
    "URL": "https://anthro.amnh.org/anthropology/databases/common/image_dup.cfm?catno=" + item["Catalog No"],
...
headings = "auto"
if len(a.FIELD_LIST):
    headings = [f.strip() for f in a.FIELD_LIST.split(",")]
io.writeCsv(a.OUTPUT_FILE, cleanedItems, headings=headings)
