...
parser.add_argument('-cache', dest="CACHE_FILE", default="data/MexicoAndCentralAmerica_locales.csv", help="A file to save the progress of locale lookup")
parser.add_argument('-out', dest="OUTPUT_FILE", default="data/MexicoAndCentralAmerica_geocoded.csv", help="Output csv file")
